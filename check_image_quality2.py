...
def blur_photo_check(image_path):
...
def check_image_quality(image):
  ...
  #Blurred Photo check
  laplacian_var = blur_photo_check(image_path)

  #face detection here
  face_detector_plot_rect(image)
  ...
  if jaw is None:
    print("Image is not acceptable,Face not detected clearly")
  else:
